...
**MW: move output;
copy "$gc_data/data_analysis/output_event_study/tables/InteractHighAODTable_s1_10km_18BE_to_18AE_18b_fs.tex" "$tables_mw/table3_ctsaod.tex", public replace;
copy "$gc_data/data_analysis/output_event_study/tables/InteractHighAODTable_s1_10km_18BE_to_18AE_18b_fs.csv" "$tables_mw/table3_ctsaod.csv", public replace;
