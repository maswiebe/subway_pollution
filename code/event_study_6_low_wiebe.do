...
quietly log using event_study_5a.log, text replace; */
		...
		{;
			...
			{;
				...
				*drop outlier AOD months;
				...
				{;
				gen citybymonth = 1;
				gen donut_25_10=((aod_mean_25km*c(pi)*25^2)-(aod_mean_10km*c(pi)*10^2))/((c(pi)*25^2)-(c(pi)*10^2));
				gen donut_50_25=((aod_mean_50km*c(pi)*50^2)-(aod_mean_25km*c(pi)*25^2))/((c(pi)*50^2)-(c(pi)*25^2));
				gen donut_150_50=((aod_mean_150km*c(pi)*150^2)-(aod_mean_50km*c(pi)*50^2))/((c(pi)*150^2)-(c(pi)*50^2));

				*Specification (3), 10-25 donut ;
				display "areg donut_25_10 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'} aod_count_`ring' `weights', a(C11) $error";
				areg donut_25_10 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'} aod_count_`ring' `weights', a(C11) $error;
				set seed 123456789;
				...
				*Specification (3), 25-50 donut ;
				display "areg donut_50_25 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'} aod_count_`ring' `weights', a(C11) $error";
				areg donut_50_25 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'} aod_count_`ring' `weights', a(C11) $error;
				set seed 123456789;
				boottest plus1, noci nograph;
				global boot_pv = r(p);
				display $boot_pv;
				...
				*Specification (4), 10-25 donut ;
				display "areg donut_25_10 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'_Xcont} c.aod_count_`ring'#i.continent_n `weights', a(C11) $error";
				areg donut_25_10 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'_Xcont} c.aod_count_`ring'#i.continent_n `weights', a(C11) $error;
				set seed 123456789;
				boottest plus1, noci nograph;
				global boot_pv = r(p);
				display $boot_pv;
				...
				*Specification (4), 25-50 donut ;
				display "areg donut_50_25 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'_Xcont} c.aod_count_`ring'#i.continent_n `weights', a(C11) $error";
				areg donut_50_25 ${dist2event} $C1 satdum citybymonth ${${pre_x_}C2_`ring'_Xcont} c.aod_count_`ring'#i.continent_n `weights', a(C11) $error;
				set seed 123456789;
				boottest plus1, noci nograph;
				global boot_pv = r(p);
				display $boot_pv;
				...
				{;
				esttab using "${prefix}Table_s`sample'_decay_`lob'BE_to_`hib'AE_`bin'b_`suffix'" , replace
					...
					nonotes addnotes("Dependent variable: Mean AOD in a donut centered around the city center."
