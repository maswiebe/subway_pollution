		...
		{;
			...
			{;
				...
				**MW use low AOD sample;
					keep if hiAOD_dummy == 0 | date_start<tm(2000m2) | date_start==.;
...
**MW: move output;
copy "$gc_data/data_analysis/output_event_study/tables/InteractHighAODTable_s1_10km_18BE_to_18AE_18b_fs.tex" "$tables_mw/table3_ctsaod_loaod.tex", public replace;
copy "$gc_data/data_analysis/output_event_study/tables/InteractHighAODTable_s1_10km_18BE_to_18AE_18b_fs.csv" "$tables_mw/table3_ctsaod_loaod.csv", public replace;